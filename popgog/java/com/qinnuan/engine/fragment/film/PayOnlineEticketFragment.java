...
public class PayOnlineEticketFragment extends BaseFragment {
    ...
    public PayOnlineEticketFragment() {
    }

    public PayOnlineEticketFragment(String subject, float totalPrice, String outTradeNo) {
