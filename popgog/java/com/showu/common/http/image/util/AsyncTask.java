...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = ImageLoadUtils.hasHoneycomb() ? new SerialExecutor() :
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link com.showu.common.http.image.util.AsyncTask#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link com.showu.common.http.image.util.AsyncTask.Status#RUNNING} or {@link com.showu.common.http.image.util.AsyncTask.Status#FINISHED}.
     *
