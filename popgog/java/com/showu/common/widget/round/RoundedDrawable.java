...
package com.showu.common.widget.round;
...
import com.showu.common.http.image.util.ImageWorker;
...
public class RoundedDrawable extends Drawable {
    ...
    private ImageWorker.AsyncDrawable asyncDrawable ;

    public ImageWorker.AsyncDrawable getAsyncDrawable() {
        return asyncDrawable;
    }

    public void setAsyncDrawable(ImageWorker.AsyncDrawable asyncDrawable) {
    ...
    public static Drawable fromDrawable(Drawable drawable, float radius, int border, ColorStateList borderColor, boolean isOval) {
        LogUtil.d(RoundedDrawable.class,"fromDrawable");
        if (drawable != null) {
...
//            }
            ...
            if (bm != null) {
                RoundedDrawable round= new  RoundedDrawable(bm, radius, border, borderColor, isOval);
                if(drawable instanceof ImageWorker.AsyncDrawable){
                    round.setAsyncDrawable((ImageWorker.AsyncDrawable)drawable);
                }
                return  round ;
            } else {
