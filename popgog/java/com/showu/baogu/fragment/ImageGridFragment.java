...
import com.showu.common.http.image.util.ImageCache;
import com.showu.common.http.image.util.ImageFetcher;
import com.showu.common.util.ImageUtil;
import com.showu.common.widget.RecyclingImageView;
 ...
 */
@FragmentView(id = R.layout.image_grid_fragment)
public class ImageGridFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    ...
    public ImageGridFragment(String[] urls, String urlStr,String title) {
        this.urls = urls;
        this.urlStr = urlStr;
        this.title=title ;
    }
...
//        mImageFetcher.setLoadingImage(R.drawable.empty_photo);
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        i.putExtra(ImageDetailActivity.EXTRA_RULS, urlStr);
